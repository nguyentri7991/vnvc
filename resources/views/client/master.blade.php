...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('client/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="" href="{{asset('client/css/jquery.fancybox.min.css')}}">
    <link rel="stylesheet" href="css/bootstrap-datepicker.css" href="{{asset('css/bootstrap-datepicker.css')}}">
